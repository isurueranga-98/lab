...
import {
  ...
  actions,
} from "@availableTests/SERUM_CREATININE";
import { z } from "zod";
...
type props = {
  test: SERUM_CREATININE_TYPE;
  quickTest: QuickTest;
};

export const SERUM_CREATININE_FORM = ({ quickTest, test }: props) => {
  ...
  const handleSubmit = async () => {
    ...
    const quickTestResults: SERUM_CREATININE_TYPE["results"] = [
      {
        ...test.results[0],
