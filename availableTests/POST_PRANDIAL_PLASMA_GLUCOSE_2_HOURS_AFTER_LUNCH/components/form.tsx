...
import { POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH_TYPE } from "@availableTests/POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH";
import { z } from "zod";
...
import { actions } from "@availableTests/POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH";
...
type props = {
  test: POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH_TYPE;
  quickTest: QuickTest;
};

//POST_PRANDIAL_PLASMA_GLUCOSE

export const POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH_FORM = ({
  quickTest,
  test,
}: props) => {
  ...
  const handleSubmit = async () => {
    ...
    const quickTestResults: POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_LUNCH_TYPE["results"] =
      [
        {
          ...test.results[0],
