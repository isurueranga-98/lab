...
import { POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER_TYPE } from "@availableTests/POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER";
import { z } from "zod";
...
import { actions } from "@availableTests/POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER";
...
type props = {
  test: POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER_TYPE;
  quickTest: QuickTest;
};

//POST_PRANDIAL_PLASMA_GLUCOSE

export const POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER_FORM = ({
  quickTest,
  test,
}: props) => {
  ...
  const handleSubmit = async () => {
    ...
    const quickTestResults: POST_PRANDIAL_PLASMA_GLUCOSE_2_HOURS_AFTER_DINNER_TYPE["results"] =
      [
        {
          ...test.results[0],
