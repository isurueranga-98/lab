    ...
    try {
      if (onSubmit) {
        ...
        if (result.success) {
          ...
          form.reset();
          showToast.success("Account Created!", "Your account has been created successfully. You can now log in.");
        } else {
          ...
          if (result.errors) {
            ...
            showToast.error("Registration Failed", result.message || "Failed to create account. Please try again.");
          }
        }
      }
    } catch (error) {
